    ...
    <article className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 md:p-12">
          ...
          <div className="article-body prose-coach max-w-none text-gray-800 leading-loose text-lg" dir="rtl">
        ...
        {related.length > 0 && (
          <section className="mt-16">
            <h2 className="text-2xl font-bold text-dark-blue mb-8 text-center">مقالات ذات صلة</h2>
