...
import { Globe, Calendar, Clock, Search } from 'lucide-react';
...
const BlogFr = () => {
  ...
  if (articlesFr.length === 0) {
    return /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 min-h-screen flex items-center justify-center", dir: "ltr", children: [
      /* @__PURE__ */ jsx(
        Seo,
        {
      ...
      /* @__PURE__ */ jsxs("div", { className: "text-center p-8", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold text-dark-blue mb-4", children: "Bientôt disponible" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600 mb-6", children: "Les articles en français arrivent. En attendant, consultez notre blog en arabe." }),
        /* @__PURE__ */ jsxs(Link, { to: "/blog", className: "inline-flex items-center gap-2 bg-primary-blue text-white font-bold py-3 px-8 rounded-xl hover:bg-dark-blue transition-colors", children: [
          /* @__PURE__ */ jsx(Globe, { size: 18 }),
          /* @__PURE__ */ jsx("span", { children: "المدونة بالعربية" })
        ] })
      ] })
    ] });
  }
  return /* @__PURE__ */ jsxs("div", { className: "bg-gray-50 min-h-screen pb-20", dir: "ltr", children: [
    /* @__PURE__ */ jsx(
      Seo,
      {
    ...
    featured && /* @__PURE__ */ jsx("section", { className: "bg-gradient-to-r from-primary-blue to-dark-blue text-white py-16", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center gap-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "md:w-1/2 space-y-6 text-left", children: [
        /* @__PURE__ */ jsx("span", { className: "bg-accent-yellow text-dark-blue px-4 py-1 rounded-full text-sm font-bold uppercase tracking-wider", children: "Article en vedette" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row gap-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:w-[70%]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-8 border-b border-gray-200 pb-4", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-dark-blue", children: activeCategory ? `Articles - ${activeCategory}` : "Derniers articles" }),
        ...
        rest.length === 0 ? /* @__PURE__ */ jsx("p", { className: "text-center text-gray-500 py-20", children: "Aucun article ne correspond à votre recherche." }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: rest.map((article) => /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "relative h-48 overflow-hidden", children: [
                ...
                /* @__PURE__ */ jsx("div", { className: "absolute top-4 left-4 bg-accent-yellow text-dark-blue text-xs font-bold px-3 py-1 rounded-full shadow-sm", children: article.category })
              ] }),
      ...
      /* @__PURE__ */ jsxs("aside", { className: "lg:w-[30%] space-y-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-gray-100", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-dark-blue mb-4", children: "Recherche" }),
          /* @__PURE__ */ jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsx(Search, { className: "absolute right-3 top-3.5 text-gray-400", size: 18 })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "bg-white p-6 rounded-2xl shadow-sm border border-gray-100", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-dark-blue mb-4", children: "Catégories" }),
          /* @__PURE__ */ jsx("ul", { className: "space-y-2", children: categoriesFr.map((cat) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsxs(
            "button",
            {
              onClick: () => setActiveCategory(cat.name === activeCategory ? null : cat.name),
              className: `w-full flex items-center justify-between py-2 px-3 rounded-lg transition-colors ${activeCategory === cat.name ? "bg-primary-blue text-white" : "hover:bg-blue-50 text-gray-600 hover:text-primary-blue"}`,
              children: [
                /* @__PURE__ */ jsx("span", { children: cat.name }),
                /* @__PURE__ */ jsx("span", { className: "text-xs px-2 py-0.5 rounded-full bg-gray-100 text-gray-500", children: cat.count })
              ]
            }
          ) }, cat.name)) })
        ] }),
